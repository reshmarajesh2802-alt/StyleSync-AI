...
function Stylist() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isMounted.current) {
        setError(
          err.message || "Something went wrong while generating your style."
        );
      }
    } finally {
      if (isMounted.current) {
    ...
    <div className="min-h-screen bg-black px-6 py-24 text-white">
      ...
      <div className="relative z-10 mx-auto max-w-5xl">
        ...
        <div className="mb-10 text-center">
          ...
          <h1 className="mt-4 text-4xl font-bold">AI Personal Stylist</h1>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  placeholder="e.g., Side-swept hair, teardrop earrings, comfortable fit"
          ...
          <div className="mt-10 rounded-3xl border border-pink-400/20 bg-white/5 p-8 backdrop-blur-xl md:p-10">
            <div className="mb-8 text-center">
              ...
              <h2 className="mt-3 text-3xl font-bold">
                {recommendation.title || "Custom Stylist Combination"}
              </h2>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <div className="rounded-2xl border border-white/10 bg-black/30 p-5">
                ...
                <p className="mt-2 font-medium">
                  {recommendation.outfitType || formData.outfitType}
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-white/10 bg-black/30 p-5">
                ...
                <p className="mt-2 font-medium">
                  {recommendation.color || formData.color}
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-white/10 bg-black/30 p-5">
                ...
                <p className="mt-2 font-medium">
                  {recommendation.season || formData.season}
                </p>
              </div>
            </div>
            ...
            {recommendation.pieces && (
              <div className="mt-8">
                <h3 className="mb-4 text-xl font-semibold">👗 Complete Look</h3>
                <div className="grid gap-4 sm:grid-cols-2">
                  {recommendation.pieces.top && (
                    <div className="rounded-2xl border border-white/10 bg-black/30 p-5">
                      ...
                      <p className="mt-2">{recommendation.pieces.top}</p>
                    </div>
                  )}
                  ...
                  {recommendation.pieces.bottom && (
                    <div className="rounded-2xl border border-white/10 bg-black/30 p-5">
                      ...
                      <p className="mt-2">{recommendation.pieces.bottom}</p>
                    </div>
                  )}
                  ...
                  {recommendation.pieces.shoes && (
                    <div className="rounded-2xl border border-white/10 bg-black/30 p-5">
                      ...
                      <p className="mt-2">{recommendation.pieces.shoes}</p>
                    </div>
                  )}
                  ...
                  {recommendation.pieces.accessory && (
                    <div className="rounded-2xl border border-white/10 bg-black/30 p-5">
                      ...
                      <p className="mt-2">{recommendation.pieces.accessory}</p>
                    </div>
                  )}
                </div>
              </div>
