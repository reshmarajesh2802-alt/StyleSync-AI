      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="animate-fade-up mx-auto mb-16 max-w-2xl text-center">
          ...
          <h2 className="text-4xl font-bold leading-tight sm:text-5xl lg:text-6xl">
            Your Style Journey,
            <br />
            <span className="text-pink-300">Simplified.</span>
          </h2>

          <p className="mx-auto mt-5 max-w-xl text-base leading-7 text-gray-400 sm:text-lg">
            From your personality to your perfect outfit — StyleSync makes
            finding your style effortless.
          </p>
        </div>
        ...
        <div className="relative grid gap-6 md:grid-cols-3">
          ...
          {steps.map((step, index) => (
            <div key={step.number} className="group relative">
              {/* Step Card */}
              <div className="glass glow-pink relative h-full overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 p-7 shadow-2xl backdrop-blur-2xl transition duration-500 hover:-translate-y-3 hover:border-pink-400/40 sm:p-8">
                {/* Hover Shine Effect */}
                ...
                {/* Description */}
                <p className="relative mt-4 text-sm leading-7 text-gray-400 sm:text-base">
                  {step.description}
                </p>
