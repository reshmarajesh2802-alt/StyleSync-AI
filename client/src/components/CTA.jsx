  ...
  return (
    <section className="relative overflow-hidden bg-black px-5 py-24 sm:px-6 sm:py-32">
      ...
      <div className="relative mx-auto max-w-6xl">
        {/* CTA Card */}
        <div className="glass glow-pink relative overflow-hidden rounded-[3rem] border border-white/10 bg-white/5 px-6 py-20 text-center shadow-2xl backdrop-blur-2xl sm:px-12 sm:py-24">
          {/* Decorative Circles */}
          ...
          {/* Heading */}
          <h2 className="animate-fade-up mx-auto max-w-4xl text-4xl font-bold leading-tight text-white sm:text-5xl lg:text-7xl">
            Your Style Has <br />
            <span className="text-pink-300">No Limits.</span>
          </h2>

          {/* Description */}
          <p className="mx-auto mt-7 max-w-2xl text-base leading-7 text-gray-400 sm:text-lg">
            Discover new looks, express your personality, and let StyleSync AI help you create a wardrobe that feels like you.
          </p>
          ...
          <div className="mt-10 flex flex-col justify-center gap-3 sm:flex-row">
            <button
              type="button"
              className="rounded-full bg-white px-8 py-4 font-semibold text-black shadow-xl transition duration-300 hover:scale-105 hover:bg-pink-100 hover:shadow-pink-500/20"
            >
            ...
            <button
              type="button"
              className="glass rounded-full border border-white/10 bg-white/5 px-8 py-4 font-medium text-white transition duration-300 hover:-translate-y-1 hover:bg-white/10"
            >
              Explore Style →
            </button>
          </div>
