function Hero() {
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden px-5 pb-16 pt-32 sm:px-6 sm:pt-36 lg:pb-24">
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl items-center gap-16 lg:grid-cols-2 lg:gap-12">
        ...
        <div className="animate-fade-up text-center lg:text-left">
          ...
          <p className="mx-auto mt-7 max-w-xl text-base leading-7 text-gray-400 sm:text-lg sm:leading-relaxed lg:mx-0">
            StyleSync AI brings fashion and intelligence together.
            Discover outfits that match your personality, explore
            collections, and let AI help you create your perfect look.
          </p>

          {/* Buttons */}
          <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:justify-center lg:justify-start">

            <button className="w-full rounded-full bg-white px-7 py-3.5 font-semibold text-black shadow-lg transition duration-300 hover:scale-105 hover:shadow-pink-500/20 sm:w-auto">
              ✨ Style Me with AI
            </button>

            <button className="glass w-full rounded-full px-7 py-3.5 font-medium text-white transition duration-300 hover:-translate-y-1 hover:bg-white/10 sm:w-auto">
              Explore Collections →
            </button>
